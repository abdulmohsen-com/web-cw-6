...
let degree=[10,20,30] 
let heat=[1,2,3,5,7,11]
hottestDays()
function hottestDays(){
console.log(heat[0],[1],[2],[3],[4],[5],[6],[7])
console.log(degree[1],[2],[3])
}
// <!-- 3. getBookById(bookId, books):
let books=[
{bookone: "history"}, {booktwo: "fiction"}, {bookthree: "horror"}
]
...
book()
function book(){
    console.log(books[0].bookone)
    console.log(books[1].booktwo)
    console.log(books[2].bookthree)
}
// <!-- 🔥بونص التمرين الأول -->
...
let name= prompt("اسم السلعة");

while(name != "done"){
  
  let quantity =prompt("الكمية"); 
  let price = prompt("السعر");
  products.push({product: name, quan: quantity, Pri: price});

  name = prompt("اسم السلعة");

}

for(name == "done"){
    conslose.log(products)
}
